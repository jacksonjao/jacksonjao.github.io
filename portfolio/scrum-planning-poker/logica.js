...
class Logica {
    ...
    createCard(parent, data, bigCardView, bigCardViewData) {
        ...
        if (!this.isMobile) {
            nodeCard.addEventListener("mouseover", () => {
                if (this.backupElemnt) {
                    this.backupElemnt.classList.remove("card-hover");
                }
                nodeCard.classList.add('card-hover')
                this.backupElemnt = nodeCard;
            });
        }
        ...
        nodeCard.addEventListener("click", () => {
            ...
            if (this.animationStart && this.backupDataValue !== data.getText()) {
